...
class Posts extends Component {
    ...
    async componentDidMount() {
        ...
        const {data} = await post_service.get_all_posts();
        
        const current_user = user._id;

        if(data.length > 0) {
            this.setState({ posts: this.mapToViewModel(data), current_user: current_user });
        }
    ...
    render() {
        ...
        return (
            <div className="container">
                <PageHeader title_text="Posts" />
                <div className="row">
                    <div className="col-12">
                        <p>All posts is here</p>
